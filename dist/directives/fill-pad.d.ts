...
export declare const handleFillPattern: ({ session, operandResolver }: FillPadDirectiveContext, words: readonly string[]) => void;
export declare const handleFill: ({ session, operandResolver }: FillPadDirectiveContext, words: readonly string[]) => void;
export declare const handlePadPattern: ({ session, operandResolver }: FillPadDirectiveContext, words: readonly string[]) => void;
