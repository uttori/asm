...
const testsDir = path.join(process.cwd(), "./fixtures/asar/tests");
const expectedDir = path.join(process.cwd(), "./fixtures/asar/expected");
const targetRom = path.join(process.cwd(), "./fixtures/asar/dummy_rom.sfc");
