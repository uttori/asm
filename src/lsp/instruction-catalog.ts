 ...
 * @returns {InstructionDescriptor} The descriptor.
 */
function branch(mnemonic: string, summary: string, opcode: number, size = 2): InstructionDescriptor {
 ...
 * @returns {InstructionDescriptor} The descriptor.
 */
function instruction(mnemonic: string, summary: string, modes: InstructionAddressingMode[]): InstructionDescriptor {
...
export const cpu65816Catalog: InstructionDescriptor[] = [
  ...
  instruction("BRK", "Software break / interrupt.", [{ mode: "stack", syntax: "", opcode: 0x00, size: 2 }]),
  ...
  instruction("COP", "Coprocessor enable interrupt.", [{ mode: "stack", syntax: "#const", opcode: 0x02, size: 2 }]),
  ...
  instruction("JSL", "Jump to subroutine long.", [{ mode: "absoluteLong", syntax: "long", opcode: 0x22, size: 4 }]),
  ...
  instruction("MVN", "Block move next (ascending).", [{ mode: "blockMove", syntax: "destBank,srcBank", opcode: 0x54, size: 3 }]),
  instruction("MVP", "Block move previous (descending).", [{ mode: "blockMove", syntax: "destBank,srcBank", opcode: 0x44, size: 3 }]),
  implied("NOP", "No operation.", 0xEA),
  instruction("ORA", "Bitwise OR with the accumulator.", aluModes),
  instruction("PEA", "Push effective absolute address.", [{ mode: "stack", syntax: "addr", opcode: 0xF4, size: 3 }]),
  instruction("PEI", "Push effective indirect address.", [{ mode: "stack", syntax: "(dp)", opcode: 0xD4, size: 2 }]),
  instruction("PER", "Push effective PC-relative address.", [{ mode: "stack", syntax: "label", opcode: 0x62, size: 3 }]),
  ...
  instruction("REP", "Reset status bits.", [{ mode: "immediate", syntax: "#const", opcode: 0xC2, size: 2 }]),
  ...
  instruction("SEP", "Set status bits.", [{ mode: "immediate", syntax: "#const", opcode: 0xE2, size: 2 }]),
  ...
  instruction("WDM", "Reserved (William D. Mensch) opcode.", [{ mode: "immediate", syntax: "#const", opcode: 0x42, size: 2 }]),
...
export const spc700Catalog: InstructionDescriptor[] = [
  ...
  instruction("CALL", "Call subroutine.", [{ mode: "absolute", syntax: "!addr", opcode: 0x3F, size: 3 }]),
