...
const testsDir = path.join(process.cwd(), "./src/Super-Ghouls-n-Ghosts-Disassembly-main");
const targetRom = path.join(process.cwd(), "./src/Super-Ghouls-n-Ghosts-Disassembly-main/test.sfc");
